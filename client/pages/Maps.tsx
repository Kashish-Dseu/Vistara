      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <Badge variant={isOffline ? "destructive" : "secondary"} className="flex items-center gap-2">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2">
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>
                  {currentLocation ? `Current location: ${getLocationName()}` : "Getting your location..."}
                </CardDescription>
              </CardHeader>
              <CardContent>
                {/* Map Container */}
          ...
          <div className="space-y-6">
            ...
            <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <p className="text-sm text-muted-foreground">Downloaded tiles:</p>
                  <p className="text-sm font-medium">{downloadedTiles.length} tiles</p>
                </div>
